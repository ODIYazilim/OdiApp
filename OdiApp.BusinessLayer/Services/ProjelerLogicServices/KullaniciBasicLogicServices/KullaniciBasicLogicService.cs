using AutoMapper;
using OdiApp.DataAccessLayer.ProjelerDataServices.KullaniciBasicDataServices;
using OdiApp.DTOs.SharedDTOs;
using OdiApp.DTOs.SharedDTOs.OrtakDTOs;
using OdiApp.EntityLayer.SharedModels;

namespace OdiApp.BusinessLayer.Services.ProjelerLogicServices.KullaniciBasicLogicServices
{
