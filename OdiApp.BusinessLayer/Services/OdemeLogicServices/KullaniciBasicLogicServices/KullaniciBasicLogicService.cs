using AutoMapper;
using OdiApp.DataAccessLayer.OdemeDataServices.KullaniciBasicDataServices;
using OdiApp.DTOs.SharedDTOs;
using OdiApp.DTOs.SharedDTOs.OrtakDTOs;
using OdiApp.EntityLayer.SharedModels;

namespace OdiApp.BusinessLayer.Services.OdemeLogicServices.KullaniciBasicLogicServices;
