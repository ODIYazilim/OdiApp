...
{
    public class ProjeRolOutputDTO
    {
        ...
        public ProjeRolOzellikOutputDTO? RolOzellik { get; set; }
        public List<ProjeRolAnketSorusuOutputDTO>? AnketSorulari { get; set; }
        public ProjeRolOdiOutputDTO RolOdi { get; set; }
